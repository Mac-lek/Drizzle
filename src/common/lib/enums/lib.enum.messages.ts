...
export const ACCOUNT_NOT_EXIST = (type: string) =>
  `${type} account does not exist`;
export const ACCOUNT_DEACTIVATED =
  "Account is deactivated, kindly contact support";
...
export const USER_BVN_NOT_MATCHING =
  "Your profile details do not match your BVN record";
...
export const VAULT_BROKEN =
  "Vault broken, remaining balance disbursed with penalty applied";
